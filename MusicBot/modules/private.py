...
from MusicBot.config import ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL,BOT_USERNAME
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                         "🤴 Owner", url=f"https://t.me/Warning_MadBoy_is_Back")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🤴 Owner', url=f"https://t.me/Warning_MadBoy_is_Back")],
